...
type SettingsPropsType = {
    gameStatus: string
    myMoves: UserInfoType[]
    opponentMoves: UserInfoType[]
}
        ...
        <div className={s.settingsContainer}>
            <div className={s.statisticsBlock}>
              <div className={s.myMoves}>
                  ...
                  {myMoves.length > 0 && <div className={s.result}>{myMoves.map((m, i) => <div key={i}>{i}. {m.board}: bulls: <span className={s.number}>{m.bulls === null ? 0 : m.bulls}</span>,
                ...
                <div className={s.opponentMoves}>
                    ...
                    {opponentMoves.length > 0 && <div className={s.result}>{opponentMoves.map((m,i) => <div key={i}>{i + 1}. {m.board}: bulls: <span className={s.number}>{m.bulls === null ? 0 : m.bulls}</span>,
